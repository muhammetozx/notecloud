  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DocumentSnapshot>(
        ...
        //    final Map <String, dynamic> doc = snapshot.data;
            ...
            final itemDeteilList =
              (documentData!['noteArray'] as List)
              .map((itemDetail) => itemDetail as Map<String,dynamic>).toList(); 
            ...
            return GridView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                final DateTime creation_date = (itemDetail['creation_date']as Timestamp).toDate();
                final int color_id = itemDetail['color_id'];

                
            return InkWell(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => NoteReaderScreen()));
              },
              child: Card(
                child: Container(
                  ...
                  child: Column(
                   crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                     ...
                     SizedBox(height: 5),
                      Text('$note_content', style:  AppStyle.mainContent, overflow: TextOverflow.ellipsis),
                      Spacer(),
                      Text('${creation_date.day.toString().padLeft(2, '0')}/${creation_date.month.toString().padLeft(2, '0')}/${creation_date.year}', style:TextStyle(fontSize: 11)),
                    ],
                  ),
                ),
              ),
